 ...
 * ---------------------
 * Program Details:
 * Device Reads a Voltage from Port_. It then displays the voltage on a LCD Display.
 * Additionally, if a button connected to Port_ is pressed, it then displays the
 * data from the attached sensor.
 * Inputs: 
 * Outputs:
 * Setup: C- Simulator
 * Date: April 29, 2023
...
{       
    ...
    //LCD_String_xy(1,0,"Look MA! I'm on");    /* Display string at location(row,location). */
                                   /* This function passes string to display */
    //LCD_String_xy(2,0,"a LCD! - Gabe");   /*Display string at location(row,location). */
                                   /* This function passes string to display */    
    ...
    while (1) {
        ...
        float Lux = 460.2106 * voltage - 244.3925;
        ...
        strcat(data," Lux");
        LCD_String_xy(1,0,"Input Reading:");
        //LCD_String_xy(2,0,"     V");
        LCD_String_xy(2,3,data);/*Send string data for printing*/
    //}
}
}
/****************************Functions********************************/
